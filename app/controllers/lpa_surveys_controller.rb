...
before_filter :authenticate_user!
  ...
  def lpa_survey_params
    ...
    lpa_questions_attributes: [:id, :title, :lpa_survey_id, :question_type, :_destroy, 
      lpa_answers_attributes:  [:id, :body, :user_id, :lpa_question_id, :issue_description, :action_taken, :_destroy] ]
    ) 
  end
end
